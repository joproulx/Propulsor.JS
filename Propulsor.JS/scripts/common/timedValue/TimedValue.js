define(["require", "exports", "scripts/common/timedValue/CachedTimedValue"], function(require, exports, __CachedTimedValue__) {
    ...
    var TimedValue = (function () {
        ...
        TimedValue.prototype.set = function (t, value, transition) {
            this.Cached.invalidate();
            if(t === undefined) {
                t = 0;
            }
            if(transition === undefined && this._defaultTransitionFactory !== undefined && this._defaultTransitionFactory !== null) {
